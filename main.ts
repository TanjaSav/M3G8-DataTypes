...
appendMessage(`New contact with deleted property: ${newContact.name}, Age: ${newContact.age}, Email: ${newContact.email ?? "deleted"}, isBobSmith: ${newContact.isBobSmith}, City: ${newContact.city}`);
